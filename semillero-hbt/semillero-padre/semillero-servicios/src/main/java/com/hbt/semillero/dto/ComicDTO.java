...
public class ComicDTO implements Serializable {
	...
	private static final long serialVersionUID = 1L;
	  ...
	  /**
         * atributo que determina llave primaria de la tabla COMIC
         */
	private Long id;
        /**
	...
	private TematicaEnum tematicaEnum;
        /**
         * Atributo que determina el tipo el conjunto de publicaciones de la que el comic es parte
         */
	...
	private BigDecimal precio;
        /**
         * Atributo que determina los autores del comic
         */
	private String autores;
        /**
         * Atributo que determina si el comic tiene color o no
         */
	private Boolean color;
        /**
         * Atributo que determina la fecha de venta de un comic
         */
	private LocalDate fechaVenta;
        /**
         * Atributo que determina el estado de un comic hay dos(activo, Inactivo)
         */
	private EstadoEnum estadoEnum;
        /**
         * Atributo que determina la cantidad de copias disponible
         */
